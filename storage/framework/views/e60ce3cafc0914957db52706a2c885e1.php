...
<?php $__currentLoopData = $listaTurmas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $turma): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td><a class="btn btn-primary btn-sm" href="<?php echo e(route('turmas.show', $turma->id)); ?>"> Informações </a></td>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('padrao.layout', ["ativo" => "turma"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mathe\Desktop\Projetos Laravel\04-Relacionamentos\resources\views/turmas/index.blade.php ENDPATH**/ ?>