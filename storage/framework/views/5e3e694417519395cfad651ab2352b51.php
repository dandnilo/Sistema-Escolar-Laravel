...
        
        ...
        <div class="modal-body">
            <div class="row">
                <form action="<?php echo e(route('alunos.definirNotasDisciplina')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="col">
...
      </div>
    </div>
</div><?php /**PATH C:\Users\mathe\Desktop\Projetos Laravel\04-Relacionamentos\resources\views/componentes/definirNotas.blade.php ENDPATH**/ ?>