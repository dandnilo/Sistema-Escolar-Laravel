...
<?php $__currentLoopData = $listaAlunos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aluno): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td><?php echo e($aluno->turma->nome); ?></td>
        <td><a class="btn btn-primary btn-sm" href="<?php echo e(route('alunos.show', $aluno->id)); ?>"> Informações </a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('padrao.layout', ["ativo" => "aluno"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mathe\Desktop\Projetos Laravel\04-Relacionamentos\resources\views/alunos/index.blade.php ENDPATH**/ ?>