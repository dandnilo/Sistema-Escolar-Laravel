...
<?php $__currentLoopData = $listaDisciplinas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disciplina): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td><a class="btn btn-primary btn-sm" href="<?php echo e(route('disciplinas.show', $disciplina->id)); ?>"> Informações </a></td>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('padrao.layout', ["ativo" => "disciplina"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mathe\Desktop\Projetos Laravel\04-Relacionamentos\resources\views/disciplinas/index.blade.php ENDPATH**/ ?>